module.exports = {
    ...
    error: {
        ...
        SERVER_ERROR_CODE_500: 'An Internal Server error has occurred...'
    },
    timestamp: {
        JAN: 'January',
        FEB: 'February',
    ...
    sites: {
        ...
        TOKEN_LOGIN_NOT_FOUND: 'Sorry, we could not find the site you selected.  Try de-activating the site, re-save it, then reactivating it.  Then try again.',
        TOKEN_LOGIN_UNKNOWN_FAILURE: 'Sorry, we could not switch to the site you requested, reason unknown.'
    },
    media: {
