...
function confirmVerifyUser(userID, userName)
{
    $('#verify_name').html(userName);
    $('#verify_button').attr('onclick', 'window.location = "/actions/admin/users/verify_user/' + userID + '"');
    $('#confirm_verify_modal').modal({backdrop: 'static', keyboard: true});
}

function confirmDeleteUser(userID, userName)
{
    $('#delete_name').html(userName);
    $('#delete_button').attr('onclick', 'window.location = "/actions/admin/users/delete_unverified_user/' + userID + '"');
