...
MemoryEntityService.prototype.onSet = function(key, value) {
    ...
    pb.CommandService.sendCommandToAllGetResponses(MemoryEntityService.getOnChangeType(this.objType), command, pb.utils.cb);
};
...
MemoryEntityService.createChangeHandler = function(memoryEntityService) {
    return function(command) {
        pb.log.info('MemoryEntityService: command received:%s', JSON.stringify(command));
        memoryEntityService._set(command.key, command.value, pb.utils.cb);
    };
};
