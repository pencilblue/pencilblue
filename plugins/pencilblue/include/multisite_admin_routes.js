...
module.exports = function Routes(pb){
    return [
        ...
        {
            method: 'post',
            path: "/api/plugins/:action/:id/:site",
            auth_required: true,
            access_level: pb.SecurityService.ACCESS_ADMINISTRATOR,
            controller: path.join(pb.config.docRoot, 'plugins', 'pencilblue', 'controllers', 'api', 'plugins', 'plugin_api.js'),
            content_type: 'application/json'
        ...
        {
            method: 'get',
            path: "/admin/:siteid/site_settings/libraries",
            access_level: pb.SecurityService.ACCESS_ADMINISTRATOR,
            auth_required: true,
        ...
        {
            method: 'post',
            path: "/actions/admin/:siteid/site_settings/libraries",
            access_level: pb.SecurityService.ACCESS_ADMINISTRATOR,
            auth_required: true,
        ...
        {
            method: 'post',
            path: "/actions/admin/:siteid/site",
            access_level: pb.SecurityService.ACCESS_ADMINISTRATOR,
            auth_required: true,
        ...
        {
            method: 'post',
            path: "/actions/admin/:siteid/site/activate/:id",
            access_level: pb.SecurityService.ACCESS_ADMINISTRATOR,
            auth_required: true,
        ...
        {
            method: 'post',
            path: "/actions/admin/:siteid/site/deactivate/:id",
            access_level: pb.SecurityService.ACCESS_ADMINISTRATOR,
            auth_required: true,
